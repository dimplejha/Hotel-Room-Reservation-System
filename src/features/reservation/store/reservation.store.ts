import { DEFAULT_RANDOM_OCCUPANCY_RATE } from '../constants/reservation.constants';
import { TOTAL_ROOMS } from '../constants/hotel.constants';
import { generateRooms } from '../services/roomGenerator.service';
import { filterAvailableRooms, generateRandomOccupancy } from '../services/occupancy.service';
import { optimizeBooking } from '../services/bookingOptimizer.service';
import { assertValidRoomCount } from '../utils/validation.util';
...
export function setOccupiedRoomsForTests(roomNumbers: number[]) {
  setState({
